      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <div className="flex gap-5 mt-6">
            <a
              href="https://github.com/krutikadhantole"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-teal-400 transition text-2xl"
            >
              <FaGithub />
            </a>
            <a
              href="https://www.linkedin.com/in/krutika-dhantole-394213269/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-teal-400 transition text-2xl"
            >
            ...
            <a
              href="https://www.instagram.com/krutikadhantole/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-teal-400 transition text-2xl"
            >
